...
DEFAULT_CLUSTER = "healthshield-eks"
DEFAULT_NAMESPACE = "health-insurance"
REGION = "us-east-1"
...
def check_eks_health(cluster_name, k8s_namespace):
    ...
    # 3. Check health-insurance deployment replica status via Prometheus
    ...
    # 4. Check pod restart counts in health-insurance namespace
